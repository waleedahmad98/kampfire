...
export default function UserFriends() {
    ...
    useEffect(() => {
        axios.get(`/users/friends/${params.email}`, { headers: { "Authorization": localStorage.getItem("accessToken") } }).then(res => {
    ...
    const removeFriend = (r) => {
        axios.put(`/users/unfriend/${params.email}`, { email: r.email, headers: { "Authorization": localStorage.getItem("accessToken") } }).then(res => {  
